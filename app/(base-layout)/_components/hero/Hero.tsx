...
const Hero = () => {
  return (
    <div className="min-h-[80vh] md:min-h-fit lg:min-h-screen ">
      <div className="relative min-h-[80vh] mt-10 md:mt-24 lg:mt-28 lg:w-[90%] 2xl:w-[70%] mx-auto px-4">
        <div
        ...
        <div className="flex flex-col-reverse md:flex-row items-center ">
          ...
          <div className="w-[70%] md:w-1/2  flex justify-center items-center lg:justify-end  ">
            ...
            <Image
              src={heroImage}
              alt=""
              className="md:w-96 md:h-96 lg:w-[440px] lg:h-[440px] xl:w-[500px] xl:h-[500px]  2xl:w-[unset] 2xl:h-[unset] z-[90]"
            ></Image>
          </div>
        </div>
      </div>
